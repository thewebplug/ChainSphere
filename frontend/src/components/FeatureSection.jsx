          ...
          {chainsphere.map((chainsphere, index) => (
            <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
              <div className="flex">
                ...
                <div>
                  <h5 className="mt-1 mb-6 text-xl">{chainsphere.text}</h5>
                  <p className="text-md p-2 mb-20 text-neutral-500">
            ...
            {chainsphere1.map((chainsphere1, index) => (
              <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
                <div className="flex">
                  ...
                  <div>
                    <h5 className="mt-1 mb-6 text-xl">{chainsphere1.text}</h5>
                    <p className="text-md p-2 mb-20 text-neutral-500">
              ...
              {chainsphere2.map((chainsphere2, index) => (
                <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
                  <div className="flex">
                    ...
                    <div>
                      <h5 className="mt-1 mb-6 text-xl">{chainsphere2.text}</h5>
                      <p className="text-md p-2 mb-20 text-neutral-500">
