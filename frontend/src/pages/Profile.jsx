        ...
        <div className="profile__main__timeline">
         ...
         <form className="profile__main__timeline__form" onSubmit={editProfile}>
           ...
           {image && <svg
                  ...
                  <label>
                  {!image && <div className="profile__main__timeline__form__img__upload">
            ...
            {image &&
             <img className="" src={URL.createObjectURL(image) || `https://gateway.pinata.cloud/ipfs/${image}`} alt="" />
             }
            </div>
            <input className="profile__main__timeline__form__input" type="text" value={name} onChange={(e) => setName(e.target.value)}  />
            <input className="profile__main__timeline__form__input" type="text" value={username} disabled />
