...
contract VRFv2Consumer is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function getRandomNumber(uint256 num) public view returns (uint256) {
     require(s_requests[lastRequestId].exists && s_requests[lastRequestId].fulfilled, "Request not fulfilled");
     uint256 randomWords = s_requests[lastRequestId].randomWords[0]; // Assuming there's only one random value
